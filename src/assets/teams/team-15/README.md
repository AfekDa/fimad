...
These eleven files are what TEAM 15 shows. To change one, replace the file and
keep the name. That is the whole procedure: nothing to import, no table to edit.

| File                       | Size        | Where it shows                                       |
| -------------------------- | ----------- | ---------------------------------------------------- |
| `all-32-teams-team-15.png` | 1024 x 683  | this team on the All 32 Teams page                   |
...
`all-32-teams-team-16.png` in here names no slot, and stops the build.
