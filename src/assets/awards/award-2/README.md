...
Award 2 shows one picture on the All Awards page and three more on its own
page at `/awards/award-2`. To change one, replace the file and keep the name.
That is the whole procedure: nothing to import, no table to edit.

| File                       | Size       | Where it shows                          |
| -------------------------- | ---------- | --------------------------------------- |
| `all-awards-award-2.png`   | 1146 x 900 | this award on the All Awards page       |
| `cards/award-2-card-1.png` | 1024 x 683 | first card on `/awards/award-2`           |
| `cards/award-2-card-2.png` | 1024 x 683 | second card                             |
| `cards/award-2-card-3.png` | 1024 x 683 | third card                              |

A card file may drop the spelled-out owner — `cards/card-2.png` fills the same
slot as `cards/award-2-card-2.png` — but a spelled-out name has to carry this
folder’s number: an `award-3-card-2.png` in here names no card, and stops
the build.
